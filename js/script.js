...
// });
$(document).ready(function() {
	$('.as__burger').click(function(event) {
		$('.as__burger,.as__menu').toggleClass('_active');
		$('body').toggleClass('_lock')
	});
});
...
const parent = document.querySelector('.header__actions');
const item = document.querySelector('.header__logo');
